...
import 'package:WHOFlutter/helpers/stream_commands.dart';
...
class _HomePageState extends State<HomePage> {
  /// handle click debounce
  StreamCommandDebounce _shareClickCommand;
  ...
  void initState() {
    ...
    _shareClickCommand = StreamCommandDebounce(
      debounce: 200,
      callback: () async {
        await share(context);
      },
  ...
  Widget build(BuildContext context) {
    final String versionString =
        packageInfo != null ? S.of(context).commonWorldHealthOrganizationCoronavirusAppVersion(packageInfo.version, packageInfo.buildNumber) : null;

    final String copyrightString = S.of(context).commonWorldHealthOrganizationCoronavirusCopyright(DateTime.now().year);

    return PageScaffold(context, title: S.of(context).homePagePageTitle, subtitle: S.of(context).homePagePageSubTitle, showBackButton: false, body: [
      SliverPadding(
          ...
          children: [
            PageButton(
              ...
              () {
                ...
                return Navigator.of(context).push(MaterialPageRoute(builder: (c) => ProtectYourself()));
              },
            ),
            PageButton(
              Color(0xff1A458E),
            ...
            PageButton(
              ...
              () {
                ...
                return Navigator.of(context).push(MaterialPageRoute(builder: (c) => TravelAdvice()));
              },
              mainAxisAlignment: MainAxisAlignment.start,
            ...
            PageButton(
              ...
              () => Navigator.of(context).push(MaterialPageRoute(builder: (c) => NewsFeed())),
              mainAxisAlignment: MainAxisAlignment.start,
        ...
        delegate: SliverChildListDelegate.fixed([
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color(0xffCA6B35)),
            ),
          ),
          Padding(
              ...
              child: FlatButton(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[Text(S.of(context).homePagePageSliverListDonate), Icon(Icons.arrow_forward_ios)],
                  ),
                  onPressed: () {
          ...
          ListTile(
            ...
            trailing: Icon(Icons.arrow_forward_ios),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (c) => SettingsPage())),
          ),
          ListTile(
            ...
            onTap: () {
              ...
              return Navigator.of(context).push(MaterialPageRoute(builder: (c) => AboutPage()));
            },
          ),
          Container(
            height: 25,
  ...
  Future share(BuildContext context) async {
    await analytics.logShare(contentType: 'App', itemId: null, method: 'Website link');
  ...
  Future _pushOnboardingIfNeeded() async {
    ...
    if (!onboardingComplete) {
      await Navigator.of(context).push(MaterialPageRoute(fullscreenDialog: true, builder: (c) => OnboardingPage()));
